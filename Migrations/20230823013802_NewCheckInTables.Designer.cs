...
namespace rentalMS2.Migrations
{
    ...
    [Migration("20230823013802_NewCheckInTables")]
    partial class NewCheckInTables
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("rentalMS2.Models.EarlyCheckIn", b =>
                {
                    b.Property<int>("EarlyCheckInId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                        .HasAnnotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn);
                    ...
                    b.HasKey("EarlyCheckInId");

                    b.HasIndex("UnitId");

                    b.ToTable("EarlyCheckIn");
                });

            modelBuilder.Entity("rentalMS2.Models.LateCheckOut", b =>
                {
                    b.Property<int>("LateCheckOutId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                        .HasAnnotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn);
                    ...
                    b.HasKey("LateCheckOutId");

                    b.HasIndex("UnitId");

                    b.ToTable("LateCheckOut");
                });
